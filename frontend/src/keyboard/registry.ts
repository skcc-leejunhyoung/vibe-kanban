...
export const sequentialBindings: SequentialBinding[] = [
  // Navigation (G = Go)
  { id: 'seq-go-settings', keys: ['g', 's'], description: 'Go to Settings', group: 'Navigation', actionId: 'settings' },
  { id: 'seq-go-new-workspace', keys: ['g', 'n'], description: 'Go to New Workspace', group: 'Navigation', actionId: 'new-workspace' },

  // Workspace (W)
  { id: 'seq-workspace-duplicate', keys: ['w', 'd'], description: 'Duplicate workspace', group: 'Workspace', actionId: 'duplicate-workspace' },
  { id: 'seq-workspace-rename', keys: ['w', 'r'], description: 'Rename workspace', group: 'Workspace', actionId: 'rename-workspace' },
  { id: 'seq-workspace-pin', keys: ['w', 'p'], description: 'Pin/Unpin workspace', group: 'Workspace', actionId: 'pin-workspace' },
  { id: 'seq-workspace-archive', keys: ['w', 'a'], description: 'Archive workspace', group: 'Workspace', actionId: 'archive-workspace' },
  { id: 'seq-workspace-delete', keys: ['w', 'x'], description: 'Delete workspace', group: 'Workspace', actionId: 'delete-workspace' },

  // View (V)
  { id: 'seq-view-changes', keys: ['v', 'c'], description: 'Toggle Changes panel', group: 'View', actionId: 'toggle-changes-mode' },
  { id: 'seq-view-logs', keys: ['v', 'l'], description: 'Toggle Logs panel', group: 'View', actionId: 'toggle-logs-mode' },
  { id: 'seq-view-preview', keys: ['v', 'p'], description: 'Toggle Preview panel', group: 'View', actionId: 'toggle-preview-mode' },
  { id: 'seq-view-sidebar', keys: ['v', 's'], description: 'Toggle Left Sidebar', group: 'View', actionId: 'toggle-left-sidebar' },
