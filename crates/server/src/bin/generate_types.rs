...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        server::routes::relay_webrtc::WebRtcTransportStatus::decl(),
        server::routes::relay_webrtc::StartWebRtcUpgradeRequest::decl(),
        server::routes::relay_webrtc::StartWebRtcUpgradeResponse::decl(),
        server::routes::relay_webrtc::FinalizeWebRtcUpgradeRequest::decl(),
        server::routes::relay_webrtc::FinalizeWebRtcUpgradeResponse::decl(),
        server::routes::relay_webrtc::WebRtcStatusResponse::decl(),
