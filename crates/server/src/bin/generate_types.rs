...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::scratch::WorkspaceActivityStatusData::decl(),
        ...
        server::routes::execution_processes::SubagentTranscript::decl(),
        ...
        server::routes::sessions::CreateHandoffAttempt::decl(),
        ...
        server::routes::workspaces::git::PullWorkspaceRequest::decl(),
        server::routes::workspaces::git::ResetWorkspaceToRemoteRequest::decl(),
        ...
        server::routes::sessions::review::VibeReviewRequest::decl(),
        ...
        server::routes::workspaces::pr::ListAttachablePrsQuery::decl(),
        ...
        server::routes::repo::PushRepoBranchRequest::decl(),
        ...
        api_types::AgentMemoryScope::decl(),
        api_types::AgentMemoryMutationOperation::decl(),
        api_types::AgentMemoryMutation::decl(),
        api_types::CreateAgentMemoryMutationRequest::decl(),
        api_types::AgentMemorySyncTarget::decl(),
        api_types::RegisterAgentMemorySyncTargetRequest::decl(),
        api_types::AgentMemorySyncSession::decl(),
        api_types::AgentMemorySyncSessionTarget::decl(),
        api_types::CreateAgentMemorySyncSessionRequest::decl(),
        api_types::AgentMemorySyncJob::decl(),
        api_types::ReportAgentMemorySyncJobRequest::decl(),
        server::agent_memory_sync::AgentMemorySyncStatus::decl(),
        server::agent_memory_sync::AgentMemorySyncLogEntry::decl(),
        server::agent_memory_sync::AgentMemoryHostRunResult::decl(),
        server::agent_memory_sync::AgentMemoryGlobalRunResult::decl(),
        server::agent_memory_sync::AgentMemoryPendingStatus::decl(),
        ...
        executors::logs::artifacts::ArtifactStatus::decl(),
        executors::logs::artifacts::ArtifactReference::decl(),
        executors::logs::artifacts::ArtifactList::decl(),
        executors::logs::artifacts::ArtifactResource::decl(),
        executors::logs::artifacts::ArtifactBundle::decl(),
        ...
        executors::logs::SubagentControl::decl(),
        executors::logs::SubagentControlTarget::decl(),
