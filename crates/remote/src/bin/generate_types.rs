...
use api_types::{
    Attachment, AttachmentUrlResponse, AttachmentWithBlob, Blob, CreateGithubIssueLinkRequest,
    CreateIssueAssigneeRequest, CreateIssueCommentReactionRequest, CreateIssueCommentRequest,
    CreateIssueFollowerRequest, CreateIssueMilestoneRequest, CreateIssueRelationshipRequest,
    CreateIssueRequest, CreateIssueTagRequest, CreateProjectMilestoneRequest, CreateProjectRequest,
    CreateProjectStatusRequest, CreatePullRequestCommentNotificationRequest,
    CreatePullRequestIssueRequest, CreateTagRequest, ExportRequest, GitHubCredentialSource,
    GitHubCredentialStatus, GitHubPullRequestComment, GitHubPullRequestCommentsResponse,
    GitHubPullRequestCommit, GitHubPullRequestDetail, GitHubPullRequestReview,
    GitHubPullRequestReviewRequest, GitHubPullRequestReviewRequestAction, GitHubPullRequestStatus,
    GitHubPullRequestSummary, GitHubRepository, GithubIssueLink, Issue, IssueAssignee,
    IssueComment, IssueCommentReaction, IssueFollower, IssueMilestone, IssuePriority,
    IssueRelationship, IssueRelationshipType, IssueSortField, IssueTag, ListIssuesQuery,
    ListIssuesResponse, ListPullRequestIssueMappingsRequest, ListPullRequestIssueMappingsResponse,
    MemberRole, Notification, NotificationGroupKind, NotificationPayload, NotificationType,
    OrganizationMember, Project, ProjectMilestone, ProjectStatus, PullRequest, PullRequestIssue,
    PullRequestIssueMapping, PullRequestStatus, RegisterGitHubCredentialRequest,
    SearchIssuesRequest, SetGitHubReviewThreadResolvedRequest, SortDirection, Tag,
    UpdateGithubIssueLinkRequest, UpdateIssueCommentReactionRequest, UpdateIssueCommentRequest,
    UpdateIssueRequest, UpdateNotificationRequest, UpdateProjectMilestoneRequest,
...
fn export_shapes() -> String {
    ...
    let type_decls = vec![
        ...
        Project::decl(),
        Notification::decl(),
        CreatePullRequestCommentNotificationRequest::decl(),
        ...
        ProjectStatus::decl(),
        Tag::decl(),
        ProjectMilestone::decl(),
        IssueMilestone::decl(),
        Issue::decl(),
        GithubIssueLink::decl(),
        IssueAssignee::decl(),
        Blob::decl(),
        Attachment::decl(),
        ...
        PullRequestIssueMapping::decl(),
        ListPullRequestIssueMappingsRequest::decl(),
        ListPullRequestIssueMappingsResponse::decl(),
        CreatePullRequestIssueRequest::decl(),
        GitHubRepository::decl(),
        GitHubPullRequestStatus::decl(),
        GitHubPullRequestSummary::decl(),
        GitHubPullRequestDetail::decl(),
        GitHubPullRequestReview::decl(),
        GitHubPullRequestCommit::decl(),
        GitHubPullRequestReviewRequestAction::decl(),
        GitHubPullRequestReviewRequest::decl(),
        GitHubPullRequestCommentsResponse::decl(),
        GitHubPullRequestComment::decl(),
        SetGitHubReviewThreadResolvedRequest::decl(),
        GitHubCredentialSource::decl(),
        GitHubCredentialStatus::decl(),
        RegisterGitHubCredentialRequest::decl(),
        CreateGithubIssueLinkRequest::decl(),
        UpdateGithubIssueLinkRequest::decl(),
        SortDirection::decl(),
        UserData::decl(),
        User::decl(),
        ...
        CreateProjectMilestoneRequest::decl(),
        UpdateProjectMilestoneRequest::decl(),
        CreateIssueMilestoneRequest::decl(),
