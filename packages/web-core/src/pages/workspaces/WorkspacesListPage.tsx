...
/**
 * Host-neutral workspace landing page shared by local and remote web.
 *
  ...
  return (
    <div className="flex h-full min-h-0 flex-1">
      ...
      <div className="flex min-w-0 flex-1">
        <WorkspacePaneGrid
          primary={
            <div className="flex h-full min-w-0 flex-1 items-center justify-center bg-primary px-double text-center text-sm text-low">
