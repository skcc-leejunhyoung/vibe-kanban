    ...
    items: [
      ...
      },
      {
        ...
        items: [
          ...
          { type: 'action', action: Actions.WorkspaceOpenGithubIssueInWeb },
    ...
    items: [
      {
        ...
        items: [
          ...
          { type: 'action', action: Actions.AddIssueTags },
          { type: 'action', action: Actions.RemoveIssueTags },
          ...
          { type: 'action', action: Actions.IssueOpenGithubIssueInWeb },
          { type: 'action', action: Actions.IssueOpenPRInWeb },
          { type: 'action', action: Actions.IssueOpenPRInPullRequests },
