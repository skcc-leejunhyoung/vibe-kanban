...
export type VibeReviewRequest = { executor_config: ExecutorConfig | null, };
...
export type PullRequestDetail = { number: bigint, url: string, status: MergeStatus, merged_at: string | null, merge_commit_sha: string | null, title: string, body: string, author: string | null, assignees: Array<string>, reviewers: Array<string>, reviews: Array<PullRequestReview>, review_requests: Array<PullRequestReviewRequest>, commits: Array<PullRequestCommit>, review_decision: string | null, is_draft: boolean, created_at: string | null, updated_at: string | null, base_branch: string, head_branch: string, };
...
export type PullRequestReviewRequestAction = "requested" | "rerequested";

export type PullRequestReviewRequest = { id: string, actor: string, requested_reviewer: string, action: PullRequestReviewRequestAction, created_at: string, };
...
export type ActionType = { "action": "file_read", path: string, } | { "action": "image_view", path: string, } | { "action": "file_edit", path: string, changes: Array<FileChange>, } | { "action": "command_run", command: string, result: CommandRunResult | null, category: CommandCategory, } | { "action": "search", query: string, } | { "action": "web_fetch", url: string, } | { "action": "tool", tool_name: string, arguments: JsonValue | null, result: ToolResult | null, } | { "action": "task_create", description: string, subagent_type: string | null, result: ToolResult | null,
/**
