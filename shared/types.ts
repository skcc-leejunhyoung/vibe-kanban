...
export type DataChannelRequest = { id: string, method: string, path: string, headers: Array<[string, string]>, 
/**
 * Base64-encoded request body, if any.
 */
body_b64?: string | null, };

export type DataChannelResponse = { id: string, status: number, headers: Array<[string, string]>, 
/**
