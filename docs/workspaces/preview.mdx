...
<Note>
For detailed setup including the Web Companion for component selection, see [Projects & Repositories](/settings-beta/projects-repositories).
</Note>
...
- [Projects & Repositories](/settings-beta/projects-repositories) - Configure dev server and repository scripts
