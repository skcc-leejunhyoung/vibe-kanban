...
<Note>
For detailed setup including the Web Companion for component selection, see [Projects & Repositories](/settings/projects-repositories).
</Note>
...
- [Projects & Repositories](/settings/projects-repositories) - Configure dev server and repository scripts
