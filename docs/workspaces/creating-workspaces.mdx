...
<Step title="Select an Agent">
  ...
  <Note>
  See [Agent Configurations](/settings-beta/agent-configurations) for details on setting up different agents.
  </Note>
</Step>
...
<Note>
After creating a project, you can configure additional settings like setup scripts, dev server scripts, and cleanup scripts in the project settings. See [Projects & Repositories](/settings-beta/projects-repositories) for more details.
</Note>
...
<Note>
Configure dev server scripts in your project settings. See [Projects & Repositories](/settings-beta/projects-repositories) for setup instructions.
</Note>
