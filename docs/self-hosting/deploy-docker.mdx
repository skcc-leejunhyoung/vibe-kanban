...
# Relay base domain (required if you enable relay/tunnel)
# The relay browser URL pattern is: https://{host_id}.relay.your-domain.com
RELAY_BASE_DOMAIN=relay.your-domain.com
...
<Info>
This base deployment serves the main Cloud app/API only. Relay/tunnel support is optional and requires additional relay routing plus wildcard DNS/TLS for `*.${RELAY_BASE_DOMAIN}`.
</Info>
