...
<Step title="Create your first workspace">
  You'll land on the Workspaces page. Click the **+** button to [create a workspace](/workspaces/creating-workspaces) with your project repositories.
</Step>

<Step title="Add tasks">
  Start tracking your work by [creating issues](/cloud/issues) or describing tasks directly in the workspace chat.
</Step>
