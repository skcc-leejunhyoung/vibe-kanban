...
<CardGroup cols={2}>
  <Card title="User Guide" icon="book" href="/workspaces/index">
    Complete guides for creating workspaces, sessions, and working with coding agents
  </Card>

  <Card title="Settings" icon="gear" href="/settings-beta/general">
