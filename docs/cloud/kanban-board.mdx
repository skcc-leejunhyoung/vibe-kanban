...
- Seeing all issues including hidden statuses
...
To switch to list view, click the **All** tab in the header. To return to board view, click the **Active** tab.
...
| Tab | View | Shows |
|-----|------|-------|
| **Active** | Board | Kanban columns for visible statuses |
| **All** | List | All issues including hidden statuses |
| **Backlog**, **Cancelled**, etc. | List | Issues in that specific hidden status |
